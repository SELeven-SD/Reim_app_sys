...
1. **访问前端**
   - 打开: http://211.87.236.94

2. **查看申请列表**
   - 点击顶部导航栏的“我的申请”
   - 或直接访问: http://211.87.236.94/my-reimbursements
...
1. 登录后台: http://211.87.236.94/admin
...
- **提交申请**: http://211.87.236.94/
- **我的申请**: http://211.87.236.94/my-reimbursements
