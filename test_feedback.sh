...
echo ""
echo "1. 在后台创建测试数据："
echo "   访问: http://211.87.236.61/admin"
echo "   用户名: admin"
echo "   密码: admin123"
echo ""
echo "2. 进入 '报销申请' 管理"
...
echo "========================================="
echo ""
echo "前端首页（提交申请）: http://211.87.236.61"
echo "我的申请（查看反馈）: http://211.87.236.61/my-reimbursements"
echo "后台管理: http://211.87.236.61/admin"
echo ""
